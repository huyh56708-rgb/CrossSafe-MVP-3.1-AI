(function(){
  ...
  widget.innerHTML=`
    ...
    <section class="ai-chat" id="aiChat" aria-label="CrossSafe AI assistant">
      <header class="ai-head"><div class="ai-brand"><span class="ai-logo">✦</span><span><b>CrossSafe AI</b><small>AI SAFETY ASSISTANT · GPT-5.6 LUNA</small></span></div><button class="ai-close" id="aiClose" aria-label="Close">×</button></header>
